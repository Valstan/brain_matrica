...
**Status:** ACTIVE
**Updated:** 2026-05-22 (Claude Opus 4.7 session — dispatch + Tier 1 orchestration tools)
**Branch:** main
...
- **MatricaRMZ:** 3 sent (0001, 0003, 0006) — лимит достигнут
- **GONBA:** 2 sent (0001, 0006)
- **setka:** 5 sent (0001, 0002, 0004, 0005, 0006) — **превышен лимит** (3 по протоколу). Стартовая партия — допустимо. **Стоп-лист**: новые заявки в setka не отправлять до закрытия минимум двух текущих.
