...
**Status:** ACTIVE
**Updated:** 2026-05-24 (Claude Opus 4.7 — пакет MatricaRMZ ack'нут + applied; pool #005 + #006 оформлены, 3 директивы #006 отправлены)
**Branch:** main
...
- PR (новый, эта сессия #1): MatricaRMZ token-economy acks архивированы + GONBA report acknowledged + pool #005 candidate ([brain_matrica#27](https://github.com/Valstan/brain_matrica/pull/27))
- PR (эта сессия #2): pool #006 full-session SSH opt-in + 3 директивы (MatricaRMZ/GONBA/KARMAN)
...
#### Pool #006 full-session SSH opt-in (3 директивы, recommend/low — 2026-05-24)

- MatricaRMZ → [`2026-05-24-full-session-ssh-optin.md`](../mailboxes/MatricaRMZ/from-brain/2026-05-24-full-session-ssh-optin.md) — добавить третий вариант в `AskUserQuestion` `/start`-skill про прод-probe. Без timing-привязки.
- GONBA → [`2026-05-24-full-session-ssh-optin.md`](../mailboxes/GONBA/from-brain/2026-05-24-full-session-ssh-optin.md) — актуально для предстоящей dev-сессии по SQL prod-redesign-config.
- KARMAN → [`2026-05-24-full-session-ssh-optin.md`](../mailboxes/KARMAN/from-brain/2026-05-24-full-session-ssh-optin.md) — взять при пробуждении проекта одним пакетом с #003 (SESSION_HANDOFF).
